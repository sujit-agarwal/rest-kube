...
{{ include "rest-server.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "rest-server.selectorLabels" -}}
...
*/}}
{{- define "rest-server.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "rest-server.fullname" .) .Values.serviceAccount.name }}
{{- else }}
